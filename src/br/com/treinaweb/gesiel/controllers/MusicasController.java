...
import br.com.treinaweb.gesiel.repositorios.RepositorioAlbum;
import br.com.treinaweb.gesiel.repositorios.RepositorioMusica;
...
public class MusicasController {
	...
	public String alterar(@PathVariable("id") Long id , Model model){
		...
		Musica musicaASerAlterado = repositorioMusica.findOne(id);
		model.addAttribute("musica", musicaASerAlterado);
	...
	public @ResponseBody List<Musica> pesquisaNomeMusica(@RequestParam(name = "nome", defaultValue="") String nomeMusica){
